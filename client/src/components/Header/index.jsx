  ...
  render () {
    ...
    return (
      <div className='H(50px) Bgc(#ddd) Px(50px) Lh(50px)'>
        <span className='Cur(p) Px(10px)' onClick={this.props.goToMain}>Main page</span>
        <span className='Cur(p) Px(10px)' onClick={this.props.goToClasses}>Classes</span>
        <span className='Cur(p) Px(10px) Fl(end)' onClick={this.props.logout}>Exit</span>
